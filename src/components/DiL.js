...
function DiL() {
  return (
    <div className={classes.dilContainer}>
      <div className="row">
        <div className={classes.dilLeft}>
        ...
        <div className={classes.dilRight}>
          <img className={classes.dilImg} src={image} alt="design is life" />
        </div>
      </div>
    </div>
  );
